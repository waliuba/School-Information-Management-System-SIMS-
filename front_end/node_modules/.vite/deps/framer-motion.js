...
var AsyncMotionValueAnimation = class extends WithPromise {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe, options, sync2) {
    ...
    let animation;
    if (useWaapi) {
      options.element = (_b = (_a = options.motionValue) == null ? void 0 : _a.owner) == null ? void 0 : _b.current;
      try {
...
var MotionValue = class {
  ...
  onChangeSubscribe(callback) {
    ...
    return () => {
      ...
      if (this.changeSubscriber === callback) {
        ...
        (_a = events.change) == null ? void 0 : _a.remove(callback);
      }
  ...
  stopIfUnobserved() {
    frame.read(() => {
      var _a;
      if (!this.changeSubscriber && !((_a = this.events.change) == null ? void 0 : _a.getSize())) {
        this.stop();
      }
    });
  }
  ...
  notifyChange() {
    ...
    if (changeSubscriber) {
      ...
      (_a = this.events.change) == null ? void 0 : _a.notify(current2);
    }
  }
  ...
  start(startAnimation) {
    ...
    return new Promise((resolve) => {
      ...
      animation = startAnimation(() => {
        var _a2;
        isComplete = true;
        (_a2 = this.events.animationComplete) == null ? void 0 : _a2.notify();
      ...
      if (!isComplete)
        this.animation = animation;
      (_a = this.events.animationStart) == null ? void 0 : _a.notify();
    });
  }
  /**
...
var DOMKeyframesResolver = class extends KeyframeResolver {
  ...
  measureInitialState() {
    ...
    if (measureKeyframe !== void 0) {
      (_a = this.motionValue) == null ? void 0 : _a.jump(measureKeyframe, false);
    }
  }
  measureEndState() {
    var _a, _b;
    ...
    if (!element || !element.current)
      return;
    (_a = this.motionValue) == null ? void 0 : _a.jump(this.measuredOrigin, false);
    ...
    if ((_b = this.removedTransforms) == null ? void 0 : _b.length) {
...
function animateValues(getValue, keyframes2, transition = {}, element) {
  ...
  const reduceMotion = transition.reduceMotion ?? (element == null ? void 0 : element.shouldReduceMotion);
...
var MotionValueState = class {
  ...
  set(name, value, render, computed) {
    var _a;
    (_a = this.values.get(name)) == null ? void 0 : _a.onRemove();
    if (computed) {
...
function createEffect(addValue, { step, ...options } = {}) {
  ...
  return Object.assign(effect, options, {
    ...
    flush: (subject) => {
      var _a;
      return (_a = stateCache.get(subject)) == null ? void 0 : _a.flush();
    },
...
function buildTransform(state) {
  ...
  const pathRotation = (_a = state.get("pathRotation")) == null ? void 0 : _a.get();
  if (pathRotation) {
...
var styleValue = (state, key) => {
  var _a;
  return getValueAsType((_a = state.get(key)) == null ? void 0 : _a.get(), numberValueTypes[key]);
};
  ...
  if (key === "pathOffset") {
    ...
    if (!state.get("stroke-dasharray")) {
      state.set("stroke-dasharray", new MotionValue("1 1"), () => {
        var _a, _b;
        const pathLength = ((_a = state.get("pathLength")) == null ? void 0 : _a.get()) ?? 1;
        const pathSpacing = (_b = state.get("pathSpacing")) == null ? void 0 : _b.get();
...
var readSVGValue = (element, key) => {
  var _a;
  if (transformProps.has(key)) {
    return ((_a = numberValueTypes[key]) == null ? void 0 : _a.default) || 0;
  }
...
function handOffElementState(element, visualElement) {
  ...
  state.release().forEach((value, key) => {
    const derived = key === "transformBox" || key === "transform" && (transformKeys2 == null ? void 0 : transformKeys2.length);
...
function attachFollow(value, source, options = {}) {
  ...
  const onPlay = () => {
    var _a;
    return (_a = value["events"].animationStart) == null ? void 0 : _a.notify();
  };
  ...
  value.attach((v, safeSet) => {
    ...
    if ((activeAnimation == null ? void 0 : activeAnimation.state) === "running") {
    ...
    animation.then(() => {
      ...
      activeAnimation = null;
      value.animation = void 0;
      (_a = value["events"].animationComplete) == null ? void 0 : _a.notify();
    });
  }, stopAnimation2);
